...
async function create_buttons_tictactoe(id, nPlayers, matrice, winmoves = [null, null, null, null, null, null, null, null, null]) {
    const row1 = new DiscordJS.MessageActionRow().addComponents(
    ...
    const row2 = new DiscordJS.MessageActionRow().addComponents(
        new DiscordJS.MessageButton()
    ...
    const row3 = new DiscordJS.MessageActionRow().addComponents(
        new DiscordJS.MessageButton()
